...
public class SimpleSiteKeys {
    ...
    static final String SSL_ENABLED = "site.ssl";
    static final String SSL_FILE = "site.ssl.file";
    static final String SSL_PORT = "site.ssl.port";
    static final String RG_TYPE = "rg.type";
    static final String RG_PATH = "rg.path";
